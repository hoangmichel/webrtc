...
{
  'dependencies': [
    '<(webrtc_depot_dir)/base/base.gyp:base_java',
    '<(webrtc_depot_dir)/build/android/pylib/device/commands/commands.gyp:chromium_commands',
    '<(webrtc_depot_dir)/build/android/pylib/remote/device/dummy/dummy.gyp:remote_device_dummy_apk',
    '<(webrtc_depot_dir)/testing/android/appurify_support.gyp:appurify_support_java',
  ...
  'conditions': [
     ['OS == "android"', {
       'variables': {
         ...
         'java_in_dir': '<(webrtc_depot_dir)/testing/android/native_test/java',
