...
{
  'dependencies': [
    '<(peeracle_webrtc_root)/base/base.gyp:base_java',
    '<(peeracle_webrtc_root)/build/android/pylib/device/commands/commands.gyp:chromium_commands',
    '<(peeracle_webrtc_root)/build/android/pylib/remote/device/dummy/dummy.gyp:remote_device_dummy_apk',
    '<(peeracle_webrtc_root)/testing/android/appurify_support.gyp:appurify_support_java',
  ...
  'conditions': [
     ['OS == "android"', {
       'variables': {
         ...
         'java_in_dir': '<(peeracle_webrtc_root)/testing/android/native_test/java',
