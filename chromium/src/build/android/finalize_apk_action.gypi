...

{
  ...
  'variables': {
    'keystore_path%': '<(webrtc_depot_dir)/build/android/ant/chromium-debug.keystore',
  ...
  'inputs': [
    '<(webrtc_depot_dir)/build/android/gyp/finalize_apk.py',
  ...
  'action': [
    'python', '<(webrtc_depot_dir)/build/android/gyp/finalize_apk.py',
