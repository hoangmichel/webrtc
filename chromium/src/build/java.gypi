    ...
    ['has_java_resources == 1', {
      ...
      'actions': [
        # Generate R.java and crunch image resources.
        {
          ...
          'variables': {
            'android_manifest': '<(webrtc_depot_dir)/build/android/AndroidManifest.xml',
          ...
          'inputs': [
            ...
            '<(webrtc_depot_dir)/build/android/gyp/generate_v14_compatible_resources.py',
  ...
  'actions': [
    ...
    },
    {
      ...
      'inputs': [
        ...
        '<(webrtc_depot_dir)/build/android/gyp/jar_toc.py',
        '<(jar_final_path)',
      ],
      'outputs': [
        '<(jar_final_path).TOC',
      ...
      'action': [
        'python', '<(webrtc_depot_dir)/build/android/gyp/jar_toc.py',
