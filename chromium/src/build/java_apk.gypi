...
#  app_manifest_version_code - set the apps version number.
{
  'variables': {
    ...
    'resource_dir%':'<(webrtc_depot_dir)/build/android/ant/empty/res',
    'R_package%':'',
    ...
    'native_libraries_template': '<(webrtc_depot_dir)/base/android/java/templates/NativeLibraries.template',
  ...
  'conditions': [
    ...
    ['native_lib_target != "" and component == "shared_library"', {
      'dependencies': [
        '<(webrtc_depot_dir)/build/android/setup.gyp:copy_system_libraries',
      ],
    }],
    ['use_chromium_linker == 1', {
      'dependencies': [
        '<(webrtc_depot_dir)/base/base.gyp:chromium_android_linker',
      ],
    }],
    ['native_lib_target != ""', {
      'variables': {
      ...
      'actions': [
        ...
        },
        {
          ...
          'inputs': [
            ...
            '<(webrtc_depot_dir)/build/android/gyp/gcc_preprocess.py',
          ...
          'action': [
            'python', '<(webrtc_depot_dir)/build/android/gyp/gcc_preprocess.py',
            '--include-path=',
        ...
        },
        {
          ...
          'inputs': [
            '<(webrtc_depot_dir)/build/android/gyp/create_placeholder_files.py',
          ],
          'outputs': [
            '<(native_lib_placeholder_stamp)',
          ],
          'action': [
            'python', '<(webrtc_depot_dir)/build/android/gyp/create_placeholder_files.py',
      ...
      'conditions': [
        ['gyp_managed_install == 1', {
          ...
          'dependencies': [
            '<(webrtc_depot_dir)/build/android/setup.gyp:get_build_device_configurations',
          ...
          'actions': [
            ...
            },
            {
              ...
              'inputs': [
                '<(webrtc_depot_dir)/build/android/gyp/util/build_utils.py',
                '<(webrtc_depot_dir)/build/android/gyp/create_device_library_links.py',
                '<(apk_install_record)',
              ...
              'action': [
                'python', '<(webrtc_depot_dir)/build/android/gyp/create_device_library_links.py',
    ...
    ['gyp_managed_install == 0 or create_standalone_apk == 1', {
      ...
      'dependencies': [
        '<(webrtc_depot_dir)/build/android/rezip.gyp:rezip_apk_jar',
      ],
    }],
    ['gyp_managed_install == 1', {
      'actions': [
        ...
        },
        {
          ...
          'inputs': [
            '<(webrtc_depot_dir)/build/android/gyp/util/build_utils.py',
            '<(webrtc_depot_dir)/build/android/gyp/apk_install.py',
            '<(build_device_config_path)',
            '<(incomplete_apk_path)',
          ],
          'outputs': [
          ...
          'action': [
            'python', '<(webrtc_depot_dir)/build/android/gyp/apk_install.py',
  ...
  'dependencies': [
    '<(webrtc_depot_dir)/tools/android/md5sum/md5sum.gyp:md5sum',
  ],
  'actions': [
    {
      ...
      'inputs': [
        '<(webrtc_depot_dir)/build/android/gyp/util/build_utils.py',
        '<(webrtc_depot_dir)/build/android/gyp/process_resources.py',
      ...
      'action': [
        'python', '<(webrtc_depot_dir)/build/android/gyp/process_resources.py',
    ...
    },
    {
      ...
      'inputs': [
        '<(webrtc_depot_dir)/build/android/gyp/apk_obfuscate.py',
        '<(webrtc_depot_dir)/build/android/gyp/util/build_utils.py',
      ...
      'action': [
        'python', '<(webrtc_depot_dir)/build/android/gyp/apk_obfuscate.py',
